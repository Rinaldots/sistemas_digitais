...
ARCHITECTURE CKT OF LETRAS IS
    ...
    SIGNAL COL0, COL1, COL2, COL3, COL4 : STD_LOGIC_VECTOR(7 DOWNTO 0);
    signal NOTSEL : STD_LOGIC_VECTOR(3 DOWNTO 0);
    signal NOTCOL : STD_LOGIC_VECTOR(2 DOWNTO 0);
    SIGNAL INVERTLEDR : STD_LOGIC_VECTOR(7 DOWNTO 0);
...
BEGIN
    ...
    COL4 <= DIGITO_SEL(34 DOWNTO 28) & '0';
    COL3 <= DIGITO_SEL(27 DOWNTO 21) & '0';
    COL2 <= DIGITO_SEL(20 DOWNTO 14) & '0';
    COL1 <= DIGITO_SEL(13 DOWNTO 7) & '0';
    COL0 <= DIGITO_SEL(6 DOWNTO 0) & '0';
    ...
    LEDR(1) <= INVERTLEDR(6);
    LEDR(0) <= INVERTLEDR(7);
    LEDG <= '0' & '0' & COL0(7) & COL1(7) & COL2(7) & COL3(7) & COL4(7) & '0'; 
