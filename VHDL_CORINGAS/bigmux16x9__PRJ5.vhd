...
ENTITY BIGMUX IS
    PORT (
        ...
        I8, I9, I10, I11, I12 : IN STD_LOGIC_VECTOR(7 DOWNTO 0);
...
BEGIN
    ...
    gen_mux : FOR i IN 0 TO 7 GENERATE
        U : MUX16X1 PORT MAP(
            '0', I0(i), I1(i), I2(i), I3(i), I4(i), '0', '0', I5(i), I6(i), I7(i),
            I8(i), I9(i), I10(i), I11(i), I12(i),
				S, Z(i)
        );
    END GENERATE;
    ...
    Ucarry : MUX16X1 PORT MAP(
        '0', C0, C1, C2, C3, C4, '0', '0', C5, '0', '0', C8,
        '0', '0', '0', '0', -- entradas extras zero
        S, C
    );
